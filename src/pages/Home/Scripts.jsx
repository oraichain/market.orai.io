      ...
      <div className={styles.container}>
        <div className={styles.wrapper}>
                ...
                <List.Item style={{ borderRadius: 10 }}>
                  <div className={styles.card}>
                    ...
                    <div className={styles.block}>
                      <span className={styles.title}>Script Name</span>: {item.name}
                    </div>
                    <div className={styles.block} style={{ height: 75 }}>
                      <span className={styles.title}>Description</span>: {item.description}
                    </div>
          ...
          <List
            ...
            dataSource={scripts.filter((item) =>
              ['oscript_btc', 'oscript_eth'].includes(item.name),
            )}
            renderItem={(item) => {
              return (
                <List.Item style={{ borderRadius: 10 }}>
                  <div className={styles.card}>
                    {item.name == 'oscript_btc' ? (
                      <img
                        alt="avatar-script"
                        className={styles.imageCoverPrice}
                        src="https://res.cloudinary.com/djy5gktft/image/upload/v1605412116/IMAGES/BC_Logo__n8szs5.png"
                      />
                    ) : (
                      <img
                        alt="avatar-script"
                        className={styles.imageCoverPrice}
                        src="https://res.cloudinary.com/djy5gktft/image/upload/v1605412117/IMAGES/ethereum_wo9qei.png"
                      />
                    )}
                    <div className={styles.block}>
                      <span className={styles.title}>Script name</span>: {item.name}
